...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Sistema Saude API", Version = "v1" });
...
builder.Services.AddCors(options =>
{
    ...
    {
        policyBuilder
            .WithOrigins("http://localhost:3000", "http://89.116.212.101:3000", "https://www.gerenciadorsaude.com.br")
            .AllowAnyMethod()
            .AllowAnyHeader();
    });
});
